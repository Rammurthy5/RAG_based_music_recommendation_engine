    ...
    _fallback_cache = [
        {
            ...
            "reason": "An emotionally uplifting anthem for when you need comfort.",
        },
        {
            "title": "Viva la Vida",
            "artist": "Coldplay",
            ...
            "reason": "Epic and sweeping — captures triumph and reflection.",
        },
        {
            "title": "Uyire",
            "artist": "A. R. Rahman",
            ...
            "reason": "A beautifully romantic Tamil classic with soaring vocals.",
        },
        {
            "title": "Munbe Vaa",
            "artist": "A. R. Rahman",
            "album": "Sillunu Oru Kaadhal",
            "genre": ["tamil film", "romantic"],
            "reason": "Dreamy and intimate — perfect for a mellow romantic mood.",
        },
        {
            "title": "Yellow",
            "artist": "Coldplay",
